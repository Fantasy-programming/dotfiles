...
alias run='pnpm run' #TODO: Change to a tool agnostic thing

alias commit="git add . && git commit -m"
alias gcfixm="git commit --amend -m"
...
alias gbsb='git bisect bad' # Tell that this is a bad commit (app broken)
alias gbsg='git bisect good' # Tell that this is a good commit (app working)
alias gbsr='git bisect reset'
alias gbss='git bisect start' # Start the binary search for error commit
...
alias gcb='git checkout -b' # switch to branch (create if not exist)
...
alias gd='git diff' # shows change made
...
alias gga='git gui citool --amend'          t
alias ggpull='git pull origin "$(git_current_branch)"'
alias ggpur=ggu
alias ggpush='git push origin "$(git_current_branch)"'
alias ggpushdel='git push origin --delete "$(git_current_branch)"'
...
alias grev='git revert' #go back to old commit
alias grh='git reset' 
...
alias gstaa='git stash apply' #apply stash with index ?
alias gstall='git stash --all'
alias gstc='git stash clear'
alias gstd='git stash drop'
alias gstl='git stash list' # show all stash
alias gstp='git stash pop' # add most recent stashed change back
